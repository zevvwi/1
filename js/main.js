...
$(document).ready(function () {
		...
		it.validate({
			...
			submitHandler: function() {
				...
				$.ajax({
					...
					success: function(){
						$('#que7').addClass('hide')
						$('#que7').removeClass('act')
						$('#que8').removeClass('hide')
						$('#que8').addClass('act')
					}
				});
			},  
	...
	$('.galler__container-more').click(function() {
		...
		$('.galler__container-item.hide').css('display', 'block');
		$('.galler__container-more.hide').css('display', 'block');
